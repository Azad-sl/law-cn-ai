          ...
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              <div className="text-xs text-gray-500 mt-4 md:m-0 dark:text-gray-100">
                * 回答由 AI 检索后台法律文件后生成，不保证准确率，仅供参考学习！<a href="http://www.azad.asia/dashang" className='ml-1 underline decoration-wavy decoration-indigo-500 underline-offset-2 hover:text-indigo-500' target='_blank'>打赏赞助</a>
              </div>
